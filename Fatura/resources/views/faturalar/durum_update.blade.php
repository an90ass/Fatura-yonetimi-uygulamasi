...
@section('content')
            ...
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('Durum_Update', ['id' => $faturalar->id]) }}" method="post" enctype="multipart/form-data"
                        autocomplete="off">
						...
						<div class="row">
                            <div class="col">
                                ...
                                <input type="text" class="form-control" id="inputName" name="fatura_numarasi"
                                    title="Lütfen fatura numarası girin" value="{{ $faturalar->fatura_numarasi }}"required readonly>
                            </div>

							<div class="col">
                                <label> Fatura tarihi</label>
                                <input class="form-control fc-datepicker" name="fatura_tarihi" placeholder="YYYY-MM-DD"
                                    type="text" value="{{ $faturalar->fatura_Tarihi }}" required readonly>
                            </div>

                            <div class="col">
                                <label>Son ödeme tarihi </label>
                                <input class="form-control fc-datepicker" name="due_tarihi" placeholder="YYYY-MM-DD"
                                    type="text"value="{{ $faturalar->Due_date }}"  required readonly>
                            </div>
                        ...
                        <div class="row">
							...
							<div class="col">
                                ...
                                <select id="urun" name="urun" class="form-control " readonly>
                            ...
                            <div class="col">
                                ...
                                <input type="text" class="form-control" id="inputName" name="Tahsilat_tutari"
                                    oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" value="{{ $faturalar->Tahsilat_tutari }}" readonly>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                ...
                                <input type="text" class="form-control form-control-lg" id="Komisyon_tutari"
                                    ...
                                    value="{{ $faturalar->Komisyon_tutari }}" readonly>
                            </div>
                            ...
                            <div class="col">
                                ...
                                <input type="text" class="form-control form-control-lg" id="kesilen_tutar" name="kesilen_tutar"
                                    ...
                                    oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');"
                                    value={{ $faturalar->indirim }} readonly>
                            </div>

                            <div class="col">
                                <label for="inputName" class="control-label">KDV oranı</label>
                                <select name="KDV_orani" id="KDV_orani" class="form-control" onchange="myFunction()" readonly>
                                    <!--placeholder-->
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <textarea class="form-control" id="exampleTextarea" name="note" rows="3" readonly>{{ $faturalar->note }}</textarea>
                            </div>
                        </div><br>
                        ...
                        <div class="row">
                            <div class="col">
                                <label for="exampleTextarea"> Ödeme durumu</label>
                                <select class="form-control" id="Status" name="Status" required>
                                    <option selected="true" disabled="disabled">--Ödeme durumunu seç--</option>
                                    <option value="Ödenmiş">Ödenmiş</option>
                                    <option value=" Kısmen ödenmiş">Kısmen ödenmiş </option>
                                </select>
                            </div>
                                           <div class="col">
                                <label for="inputName" class="control-label">Ödenmiş tutar</label>
                                <input type="text" class="form-control form-control-lg" id="odenmis_tutar" name="odenmis_tutar"
                                    title="Lütfen odenmiş tutarı giriniz"
                                    oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');"
                                    value=""readonly>
                            </div>
                            <div class="col">
                                <label>Ödeme tarihi </label>
                                <input class="form-control fc-datepicker" name="odeme_tarihi" placeholder="YYYY-MM-DD"
                                    type="text" required>
                            </div>
                        ...
                        <div class="d-flex justify-content-center">
                            <button type="submit" class="btn btn-primary"> Ödeme durumu güncelle</button>
                        </div>
...
<script>
        function myFunction() {
            ...
            if (typeof Komisyon_tutari === 'undefined' || !Komisyon_tutari) {
                ...
                var odenmis_tutar =parseFloat(document.getElementById("odenmis_tutar").value);
...
$(document).ready(function() {
  $('#Status').on('change', function() {
    if ($(this).val() == " Kısmen ödenmiş") {
      $('#odenmis_tutar').prop('readonly', false);
      $('#odenmis_tutar').prop('required', true);
    } else {
      $('#odenmis_tutar').prop('readonly', true);
      $('#odenmis_tutar').prop('required', false);
    }
  });
});
</script>
