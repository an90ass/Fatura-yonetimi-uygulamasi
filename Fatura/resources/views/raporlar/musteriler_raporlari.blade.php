...
@section('page-header')
				...
				<div class="breadcrumb-header justify-content-between">
					<div class="my-auto">
						<div class="d-flex">
							<h4 class="content-title mb-0 my-auto">Raporlar</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ muşteriler raporları</span>
						</div>
					</div>
                    ...
                    <div class="col-xl-12">
                        <div class="card mg-b-20">
                            ...
                            <div class="card-header pb-0">
                                ...
                                <form action="/Search_musteriler" method="POST" role="search" autocomplete="off">
                                    {{ csrf_field() }}
                                    <div class="row">

                                    <div class="col">
                                        <label for="inputName" class="control-label">Bölüm</label>
                                        <select name="bolum" class="form-control SelectBox">
                                      ...
                                      <div class="col">
                                        ...
                                        <select name="urun" class="form-control SelectBox"></select>
                                      </div>
...
$(document).ready(function() {
    $('select[name="bolum"]').on('change', function() {
        ...
        if (bolumId) {
            $.ajax({
                url: "{{ url('bolum') }}/" + bolumId,
                                type: "GET",
                dataType: "json",
                success: function(response) {
    $('select[name="urun"]').html(response.options);
}
            });
        } else {
